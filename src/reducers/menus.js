...
const MENU_EXAMPLES = 'examplesMenu';
...
const openExamplesMenu = () => openMenu(MENU_EXAMPLES);
const closeExamplesMenu = () => closeMenu(MENU_EXAMPLES);
const examplesMenuOpen = state => state.scratchGui.menus[MENU_EXAMPLES];
